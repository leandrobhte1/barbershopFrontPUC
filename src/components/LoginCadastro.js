...
const LoginCadastro = () => {
    ...
    const handleLogin = (e) => {
        ...
        if(usernameLogin == null || usernameLogin == "" || usernameLogin.length < 3){
            ...
            axios.post(`https://barbershoppuc-backend.herokuapp.com/api/login`, formData, {
                headers: {
            ...
            .then(resp => {
                ...
                axios.get(`https://barbershoppuc-backend.herokuapp.com/api/user/${usernameLogin}`, {
                    headers: {
                        'Access-Control-Allow-Origin': '*',
                        'Authorization': token
                      }
        ...
        if(firstName == null || firstName == "" || firstName.length < 2){
            ...
            .then(res => {
                ...
                axios.post(`https://barbershoppuc-backend.herokuapp.com/api/login`, formData, {
                    ...
                    let token = 'Bearer ' + resp.data.access_token;
                    axios.get(`https://barbershoppuc-backend.herokuapp.com/api/user/${username}`, {
                        headers: {
                            'Access-Control-Allow-Origin': '*',
                            'Authorization': token
                        }
